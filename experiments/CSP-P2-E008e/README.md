...
```json
{
  ...
  "criteria_table": [
    {
      ...
      "status_after_e008": "19.05% error reduction vs capacity-matched MLP",
      "final_status": "FAIL",
      "notes": "Under capacity-matched control and early stopping, error reduction is 19.05%. Did not reach 70% bar."
    },
    {
      "criterion_id": 2,
    ...
    },
    {
      ...
      "status_after_e008": "Win rate 7/8 against capacity-matched baseline",
      "final_status": "PARTIALLY MET",
      "notes": "Corrected win rate is 7/8. Consistent superiority=False."
    },
    {
      "criterion_id": 4,
    ...
    },
    {
      ...
      "final_status": "PASS",
      "notes": "Canonical pooled training with early stopping yields d=3 beats persistence: True, d=6 beats persistence: True."
    },
    {
      "criterion_id": 6,
  ...
  "scientific_conclusion": "PARTIALLY SUPPORTED",
  "phase3_status": {
    "is_justified": false,
    "decision": "PHASE 3 CONDITIONALLY BLOCKED",
    "blocking_items": [
      "Deficit-Step Error Reduction (>70%)",
      "8-Seed Reproducibility"
    ],
    "remediation_guidance": "Criteria failing or partially met: Deficit-Step Error Reduction (>70%), 8-Seed Reproducibility."
  }
}
```
